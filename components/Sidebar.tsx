...
interface SidebarProps {
  user: User;
  activeTab: 'dashboard' | 'explore' | 'admin' | 'leaderboard' | 'communities';
  setActiveTab: (tab: 'dashboard' | 'explore' | 'admin' | 'leaderboard' | 'communities') => void;
  onLogout: () => void;
}
      ...
      <div className="mt-auto p-6 border-t border-slate-800">
        <div className="bg-slate-800/50 rounded-2xl p-4 mb-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Level Progress</span>
          </div>
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-rose-400 hover:bg-rose-400/10 transition-all"
        >
          <LogOut size={20} />
